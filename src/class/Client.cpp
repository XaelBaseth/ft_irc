...
/*   Updated: 2024/02/15 12:21:04 by axel             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Client::setReadBuffer(std::string const &buf) { _readbuf += buf;}
...
void	Client::setSendBuffer(std::string const &buf){ _sendbuf += buf;}

void	Client::setDeconnexionStatus(bool status){ _to_deconnect = status;}

void	Client::setNickname(std::string const &nickname){ _nickname = (_nickname.size() > 9) ? nickname.substr(0, 9) : nickname;}

void	Client::setOldNickname(std::string const &nickname){ _old_nickname = nickname;}
...
void	Client::setConnexionPassword(bool boolean){ _connexion_password = boolean;}

void	Client::setRegistrationDone(bool boolean){ _registrationDone = boolean;}

void	Client::setWelcomeSent(bool boolean){ _welcomeSent = boolean;}

void	Client::setHasAllInfo(bool boolean){ _hasAllInfo = boolean;}
